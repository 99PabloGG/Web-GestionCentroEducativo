...
?>
			...
			<br>
			<br>
			<a id='btn' href='../Controller/PROF_TITULACION_Controller.php?action=ADD'><img id=icon src='../View/Icons/ADD.png'></a>
			<tab>
			<a id='btn' href='../Controller/PROF_TITULACION_Controller.php?action=SEARCH'><img id=icon src='../View/Icons/SEARCH.png'></a>
			<br><br>
		<table>
			<tr>
<?php
...
?>
				<td>
					<a id='btn' href='
						../Controller/PROF_TITULACION_Controller.php?action=EDIT&CODTITULACION=
							<?php echo $fila['CODTITULACION']; ?>&DNI=
							<?php echo $fila['DNI']; ?>
							'><img id=icon src='../View/Icons/EDIT.png'></a>
				</td>
				<td>
					<a id='btn' href='
						../Controller/PROF_TITULACION_Controller.php?action=DELETE&CODTITULACION=
							<?php echo $fila['CODTITULACION']; ?>&DNI=
							<?php echo $fila['DNI']; ?>
				...
				<td>
					<a id='btn' href='
						../Controller/PROF_TITULACION_Controller.php?action=SHOWCURRENT&CODTITULACION=
							<?php echo $fila['CODTITULACION']; ?>&DNI=
							<?php echo $fila['DNI']; ?>
