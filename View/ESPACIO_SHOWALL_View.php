...
?>
			...
			<br>
			<br>
			<a id='btn'href='../Controller/ESPACIO_Controller.php?action=ADD'><img id=icon src='../View/Icons/ADD.png'></a>
			<tab>
			<a id='btn'href='../Controller/ESPACIO_Controller.php?action=SEARCH'><img id=icon src='../View/Icons/SEARCH.png'></a>
			<br><br>
		<table>
			<tr>
<?php
